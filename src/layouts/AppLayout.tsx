...
export const AppLayout = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col antialiased">
      <header className="bg-white p-4 border-b border-gray-200 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6 md:items-center">
            ...
            <a href="#sobre" className="text-gray-800 hover:text-blue-600">Sobre</a>
            <a href="#projetos" className="text-gray-800 hover:text-blue-600">Projetos</a>
            <a href="#blog" className="text-gray-800 hover:text-blue-600">Blog</a>
            <a href="#contate-nos" className="text-white bg-[#ee325d] p-4 rounded-4xl font-medium flex items-center">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out md:hidden`}>
